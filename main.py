...
def start_web_server(port=8080):
    ...
    server = HTTPServer(('localhost', port), WebAppHandler)
...
async def post_init(application):
    ...
    web_thread.start()
    logger.info("🚀 Веб-приложение запущено: http://localhost:8080")
...
def main():
    ...
    try:
        ...
        print("🌐 Веб-приложение доступно по адресу: http://localhost:8080")
        print("🔗 Для подключения Web App в BotFather укажите URL: http://ваш_хостинг:8080")
        print("=" * 50)
